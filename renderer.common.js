...
var ReactShiftPlot = (function (_React$Component) {
    _inherits(ReactShiftPlot, _React$Component);

    function ReactShiftPlot(props) {
        _classCallCheck(this, ReactShiftPlot);

        _get(Object.getPrototypeOf(ReactShiftPlot.prototype), 'constructor', this).call(this, props);
        this.state = {};
    }

    _createClass(ReactShiftPlot, [{
        ...
        value: function componentDidMount(prevProps, prevState) {
            if (this.props.data.length) {
                ...
                var chart = shiftPlot('.chart-div.id-' + this.props.id, this.props.settings).init(this.props.data);
            }
        }
    }, {
...
var Renderer = (function (_React$Component2) {
    ...
    _createClass(Renderer, [{
        ...
        key: 'render',
        value: function render() {
            return React.createElement(ReactShiftPlot, {
                id: this.props.id,
